<%@ Page Title="" Language="C#" MasterPageFile="~/Content/AdminPanel.master" AutoEventWireup="true" CodeFile="StudentList.aspx.cs" Inherits="AdminPanel_Student_StudentList" %>
        ...
        <div class="col-12">
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <asp:UpdatePanel ID="upnlStudentList" runat="server" Visible="false">
                        <ContentTemplate>

                    <asp:GridView ID="gvStudent" runat="server" CssClass="table" AutoGenerateColumns="false" OnRowCommand="gvStudent_RowCommand" GridLines="None">
                        <Columns>
                            <asp:TemplateField>
                                <ItemTemplate>
                            ...
                            <asp:TemplateField>
                                <ItemTemplate>
                                    <div align="right">
                                        <asp:HyperLink ID="hlEdit" runat="server" Text="Edit" CssClass="btn btn-outline-primary" Width="20%" NavigateUrl='<%# "~/AdminPanel/Student/StudentAddEdit.aspx?StudentID=" + Eval("StudentID").ToString() %>' />
                                        &nbsp;
                                        <asp:Button ID="btnDelete" runat="server" Text="Delete" CssClass="btn btn-outline-danger" Width="20%" CommandName="DeleteRecord" CommandArgument='<%# Eval("StudentID") %>' />
                                    </div>
                                </ItemTemplate>
                            </asp:TemplateField>
                        </Columns>
