<%@ Page Title="" Language="C#" MasterPageFile="~/Content/AdminPanel.master" AutoEventWireup="true" CodeFile="StaffList.aspx.cs" Inherits="AdminPanel_Staff_StaffList" %>
        ...
        <div class="col-12">
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <asp:UpdatePanel ID="upnlStaffList" runat="server" Visible="false">
                        <ContentTemplate>

                    <asp:GridView ID="gvStaff" runat="server" CssClass="table" AutoGenerateColumns="false" OnRowCommand="gvStaff_RowCommand" GridLines="None">
                        <Columns>
                            <asp:TemplateField>
                                <ItemTemplate>
                            ...
                            <asp:TemplateField>
                                <ItemTemplate>
                                    <div align="right">
                                        <asp:HyperLink ID="hlEdit" runat="server" Text="Edit" CssClass="btn btn-outline-primary" Width="20%" NavigateUrl='<%# "~/AdminPanel/Staff/StaffAddEdit.aspx?StaffID=" + Eval("StaffID").ToString() %>' />
                                        &nbsp;
                                        <asp:Button ID="btnDelete" runat="server" Text="Delete" CssClass="btn btn-outline-danger" Width="20%" CommandName="DeleteRecord" CommandArgument='<%# Eval("StaffID") %>' />
                                    </div>
                                </ItemTemplate>
                            </asp:TemplateField>
                        </Columns>
