<%@ Page Title="" Language="C#" MasterPageFile="~/Content/AdminPanel.master" AutoEventWireup="true" CodeFile="CourseList.aspx.cs" Inherits="AdminPanel_Course_CourseList" %>
        ...
        <div class="col-12">
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <asp:UpdatePanel ID="upnlCourseList" runat="server" Visible="false">
                        <ContentTemplate>

                    <asp:GridView ID="gvCourse" runat="server" CssClass="table" AutoGenerateColumns="false" OnRowCommand="gvCourse_RowCommand" GridLines="None">
                        <Columns>
                            <asp:TemplateField>
                                <ItemTemplate>
                            ...
                            <asp:TemplateField>
                                <ItemTemplate>
                                    <div align="right">
                                        <asp:HyperLink ID="hlEdit" runat="server" Text="Edit" CssClass="btn btn-outline-primary" Width="20%" NavigateUrl='<%# "~/AdminPanel/Course/CourseAddEdit.aspx?CourseID=" + Eval("CourseID").ToString() %>' />
                                        &nbsp;
                                <asp:Button ID="btnDelete" runat="server" Text="Delete" CssClass="btn btn-outline-danger" Width="20%" CommandName="DeleteRecord" CommandArgument='<%# Eval("CourseID") %>' />
                                    </div>
                                </ItemTemplate>
                            </asp:TemplateField>
                        </Columns>
