<%@ Page Title="" Language="C#" MasterPageFile="~/Content/AdminPanel.master" AutoEventWireup="true" CodeFile="CourseAddEdit.aspx.cs" Inherits="AdminPanel_Course_CourseAddEdit" %>
                ...
                <div class="form-horizontal">
                    <div class="card-body">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-5">
                                <asp:TextBox ID="txtCourseName" runat="server" CssClass="form-control" placeholder="Course Name Here"></asp:TextBox>
                                <asp:RequiredFieldValidator ID="rfvCourseName" runat="server" ControlToValidate="txtCourseName" Text="Please enter Course Name" ForeColor="Red" Display="Dynamic"
