<%@ Page Title="" Language="C#" MasterPageFile="~/Content/AdminPanel.master" AutoEventWireup="true" CodeFile="GrievanceList.aspx.cs" Inherits="AdminPanel_Grievance_GrievanceList" %>
        ...
        <div class="col-12">
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <asp:UpdatePanel ID="upnlGrievanceList" runat="server" Visible="false">
                        <ContentTemplate>

                    <asp:GridView ID="gvGrievance" runat="server" CssClass="table" AutoGenerateColumns="false" OnRowCommand="gvGrievance_RowCommand" GridLines="None">
                        <Columns>
                            <asp:TemplateField>
                                <ItemTemplate>
                            ...
                            <asp:TemplateField>
                                <ItemTemplate>
                                    <div align="right">
                                        <asp:HyperLink ID="hlEdit" runat="server" Text="Edit" CssClass="btn btn-outline-primary" Width="20%" NavigateUrl='<%# "~/AdminPanel/Grievance/GrievanceAddEdit.aspx?GrievanceID=" + Eval("GrievanceID").ToString() %>' />
                                        &nbsp;
                                <asp:Button ID="btnDelete" runat="server" Text="Delete" CssClass="btn btn-outline-danger" Width="20%" CommandName="DeleteRecord" CommandArgument='<%# Eval("GrievanceID") %>' />
                                    </div>
                                </ItemTemplate>
                            </asp:TemplateField>
                        </Columns>
