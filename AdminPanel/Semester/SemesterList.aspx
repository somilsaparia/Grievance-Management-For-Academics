<%@ Page Title="" Language="C#" MasterPageFile="~/Content/AdminPanel.master" AutoEventWireup="true" CodeFile="SemesterList.aspx.cs" Inherits="AdminPanel_Semester_SemesterList" %>
        ...
        <div class="col-12">
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <asp:UpdatePanel ID="upnlSemesterList" runat="server" Visible="false">
                        <ContentTemplate>

                    <asp:GridView ID="gvSemester" runat="server" CssClass="table" AutoGenerateColumns="false" OnRowCommand="gvSemester_RowCommand" GridLines="None">
                        <Columns>
                            <asp:TemplateField>
                                <ItemTemplate>
                            ...
                            <asp:BoundField DataField="SemesterNumber" HeaderText="Semester Number" />
                            <asp:BoundField DataField="DepartmentName" HeaderText="Department Name" />
                            <asp:BoundField DataField="CourseName" HeaderText="Course Name" />
                            <asp:TemplateField>
                                <ItemTemplate>
                                    <div align="right">
                                        <asp:HyperLink ID="hlEdit" runat="server" Text="Edit" CssClass="btn btn-outline-primary" Width="20%" NavigateUrl='<%# "~/AdminPanel/Semester/SemesterAddEdit.aspx?SemesterID=" + Eval("SemesterID").ToString() %>' />
                                        &nbsp;
                                <asp:Button ID="btnDelete" runat="server" Text="Delete" CssClass="btn btn-outline-danger" Width="20%" CommandName="DeleteRecord" CommandArgument='<%# Eval("SemesterID") %>' />
                                    </div>
                                </ItemTemplate>
                            </asp:TemplateField>
                        </Columns>
