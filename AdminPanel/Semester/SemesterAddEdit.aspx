<%@ Page Title="" Language="C#" MasterPageFile="~/Content/AdminPanel.master" AutoEventWireup="true" CodeFile="SemesterAddEdit.aspx.cs" Inherits="AdminPanel_Semester_SemesterAddEdit" %>
                ...
                <div class="form-horizontal">
                    <div class="card-body">
                        ...
                        <div class="form-group row">
                            <asp:Label ID="lblSemesterNumber" runat="server" CssClass="col-sm-3 text-right control-label col-form-label" Text="Semester Number"></asp:Label>
                            <div class="col-sm-5">
                                <asp:TextBox ID="txtSemesterNumber" runat="server" CssClass="form-control" placeholder="Semester Number Here"></asp:TextBox>
                                <asp:RequiredFieldValidator ID="rfvSemesterNumber" runat="server" ControlToValidate="txtSemesterNumber" Text="Please enter Semester" ForeColor="Red" Display="Dynamic"
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-5">
                                <asp:DropDownList ID="ddlCourseName" runat="server" CssClass="select2 form-control custom-select" OnSelectedIndexChanged="ddlCourseName_SelectedIndexChanged" AutoPostBack="True"></asp:DropDownList>
