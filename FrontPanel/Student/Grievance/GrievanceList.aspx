<%@ Page Title="" Language="C#" MasterPageFile="~/Content/FrontPanelStudent.master" AutoEventWireup="true" CodeFile="GrievanceList.aspx.cs" Inherits="FrontPanel_Student_Grievance_GrievanceList" %>
        ...
        <div class="col-12">
            <div class="card">
                ...
                <div class="card-body">
                            ...
                            <div class="row">
                                <div class="col-lg-12" style="float: left;">
                                    <div class="row">
                                        ...
                                        <div class="col-lg-2">
                                            <asp:Button ID="Button1" runat="server" Text="Add Grievance" CssClass="btn btn-outline-success" OnClick="btnAdd_Click" Width="100%" />
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <asp:UpdatePanel ID="upnlStudentGrievance" runat="server" Visible="true">
                                <ContentTemplate>

                                    <asp:GridView ID="gvStudentGrievance" runat="server" CssClass="table" AutoGenerateColumns="false" OnRowCommand="gvStudentGrievance_RowCommand" GridLines="None">
                                        <Columns>
                                            <asp:TemplateField>
                                                <ItemTemplate>
                                                ...
                                                <ItemTemplate>
                                                    <div align="right">
                                                        <asp:HyperLink ID="hlEdit" runat="server" Text="Edit" CssClass="btn btn-outline-primary" 
                                                            ...
                                                            NavigateUrl='<%# "~/FrontPanel/Student/Grievance/GrievanceAddEdit.aspx?Enable=1&StudentGrievanceID=" + Eval("StudentGrievanceID").ToString() %>' />
                                                        &nbsp;
                                                        <asp:Button ID="btnDelete" runat="server" Text="Delete" CssClass="btn btn-outline-danger"  
                                                            Visible='<%# Eval("GrievanceStatus").ToString() == "In-Progress" || Eval("GrievanceStatus").ToString() == "Rejected" || Eval("GrievanceStatus").ToString() == "Resolved"? false: true %>' CommandName="DeleteRecord" CommandArgument='<%# Eval("StudentGrievanceID") %>' />
                                                        &nbsp;
                                                        <asp:HyperLink ID="hlDetails" runat="server" Text="Details" CssClass="btn btn-outline-primary" 
                                                            NavigateUrl='<%# "~/FrontPanel/Student/Grievance/GrievanceAddEdit.aspx?Enable=0&StudentGrievanceID=" + Eval("StudentGrievanceID").ToString() %>' />
                                                    </div>
                                                </ItemTemplate>
                                            </asp:TemplateField>
                                        </Columns>
