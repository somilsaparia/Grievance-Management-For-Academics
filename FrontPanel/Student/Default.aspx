<%@ Page Title="" Language="C#" MasterPageFile="~/Content/FrontPanelStudent.master" AutoEventWireup="true" CodeFile="Default.aspx.cs" Inherits="FrontPanel_Student_Default" %>
    ...
    <div class="row">
        <div class="col-md-6 col-lg-2 col-xlg-3">
            <div class="card card-hover">
                <asp:HyperLink ID="hlTotalGrievance" runat="server" NavigateUrl="~/FrontPanel/Student/Grievance/GrievanceList.aspx">
        ...
        <div class="col-md-6 col-lg-2 col-xlg-3">
            <div class="card card-hover">
                <asp:HyperLink ID="hlRegisteredGrievance" runat="server" NavigateUrl="~/FrontPanel/Student/Grievance/GrievanceList.aspx">
        ...
        <div class="col-md-6 col-lg-4 col-xlg-3">
            <div class="card card-hover">
                <asp:HyperLink ID="hlInProgressGrievance" runat="server" NavigateUrl="~/FrontPanel/Student/Grievance/GrievanceList.aspx">
        ...
        <div class="col-md-6 col-lg-2 col-xlg-3">
            <div class="card card-hover">
                <asp:HyperLink ID="hlResolveGrievance" runat="server" NavigateUrl="~/FrontPanel/Student/Grievance/GrievanceList.aspx">
        ...
        <div class="col-md-6 col-lg-2 col-xlg-3">
            <div class="card card-hover">
                <asp:HyperLink ID="hlRejectedGrievance" runat="server" NavigateUrl="~/FrontPanel/Student/Grievance/GrievanceList.aspx">
