<%@ Page Title="" Language="C#" MasterPageFile="~/Content/FrontPanelStaff.master" AutoEventWireup="true" CodeFile="StaffProfile.aspx.cs" Inherits="FrontPanel_Staff_StaffProfile" %>
                ...
                <div class="form-horizontal">
                    <div class="card-body">
                        ...
                        <div class="form-group row">
                            <div class="col-sm-3">
                                <div style="float:right;">
                                    <b><asp:Label ID="lblCode" runat="server" CssClass="text-right control-label col-form-label" Text="Staff Code"></asp:Label></b>
                                </div>
                            </div>
                            <div class="col-sm-5">
                                <div style="float:left;">
                                    <asp:Label ID="lblCodeDetail" runat="server" CssClass="text-left control-label col-form-label"></asp:Label>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="form-group row">
                            <div class="col-sm-3">
                                <div style="float:right;">
                                    <b><asp:Label ID="lblJoiningYear" runat="server" CssClass="text-right control-label col-form-label" Text="Joining Year"></asp:Label></b>
                                </div>
                            </div>
                            <div class="col-sm-5">
                                <div style="float:left;">
                                    <asp:Label ID="lblJoiningYearDetail" runat="server" CssClass="text-left control-label col-form-label"></asp:Label>
                                </div>
                            </div>
                        </div>
                    </div>
